							  ...
							  <div class="col-xs-12 col-sm-offset-0">
											<div class="widget-box">
												...
												<div class="widget-body-inner" style="display: block;">
													...
													<form id="companyForm" action="<%=request.getContextPath()%>/ht/company/news/edit.do" method="post" enctype="multipart/form-data">
														<input id="id" name="id" value="${list.id}" style="display:none"></input>
														<div>
															<label for="form-field-8">标题：</label>
															<input class="form-control limited" id="title" name="title" type="text" value=${list.title }>
														</div>
														...
														<div>
															...
															<textarea class="form-control limited" id="context" name="context" style="margin-top: 0px; margin-bottom: 0px; height: 180px;" >${list.context}</textarea>
														</div>
														...
														<div class="row" onclick="$('#id-input-file-1').click();">
															  <div class="col-xs-12  text-center">
															   <img id="companyFile" class="img-thumbnail"  src="<%=request.getContextPath()%>/${list.imageurl}" onerror="this.src='<%=request.getContextPath()%>/img/imgs/tab3_4.jpg'">								   
															  </div>
														</div>
				 ...
				 if(context==""){
				  ...
				  return ;
				   ...
				   $("#favicon_msg_icon6").hide();
      				  $.ajax({  
			            type:"POST",   //http请求方式  
			            url:"${pageContext.request.contextPath}/ht/company/news/editCheck.do", //发送给服务器的url  
