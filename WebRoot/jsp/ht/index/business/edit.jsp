							   ...
							   <!-- 插入内容 -->
							    <form class="form-horizontal" id="business_edit_form" action="<%=request.getContextPath()%>/ht/index/business/edit.do" method="post" enctype="multipart/form-data"> 
							   		...
							   		<div class="form-group">
										...
										<div class="col-sm-9">
											<input class="col-xs-10 col-sm-5" name="business_title" type="text" value="<c:out value="${indEnt.title }"></c:out>">
										</div>
									</div>
									...
									<div class="form-group">
                                         ...
                                         <div class="col-sm-9">
                                         <textarea class="col-xs-10 col-sm-5" id="business_context" name="business_context" style="height: 200px; resize: none;" ><c:out value="${indEnt.context }"></c:out></textarea>
                                         </div>
									</div>
									<div class="space-4"></div>
									<div class="form-group">
                                         ...
                                         <div class="col-sm-9 " >
                                           <div class="ace-file-input ace-file-multiple col-xs-10 col-sm-5 text-center" onclick="$('#id-input-file').click();">
                                            <img src="<%=request.getContextPath()%>/${indEnt.imageurl}" class="img-thumbnail" id="img_business"  onerror="this.src='<%=request.getContextPath()%>/img/imgs/tab3_4.jpg'" >
                                           </div>
